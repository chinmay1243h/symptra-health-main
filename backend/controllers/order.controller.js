...
const Product = require('../models/product.model'); // Needed to check product stock
...
exports.createOrder = async (req, res, next) => {
  try {
    ...
    if (orderItems && orderItems.length === 0) {
      ...
      // Check product stock before creating order (basic check)
      ...
      // Optionally, reduce product stock here after successful order creation
      for (const item of orderItems) {
