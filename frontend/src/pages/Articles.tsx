...
import { Menu, X, User, LogOut, ShieldCheck, ShoppingCart } from "lucide-react"; // IMPORT ShoppingCart
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const Navigation = () => {
  ...
  const { getCartItemCount } = useCart(); // USE THIS HOOK
  ...
  const cartItemCount = getCartItemCount(); // Get current item count
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            {/* Cart Icon */}
            <Link to="/cart"> {/* You might want to create a /cart page later */}
